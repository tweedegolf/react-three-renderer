...
var MultiMaterialDescriptorBase = (0, _resource2.default)(_class = function (_THREEElementDescript) {
  _inherits(MultiMaterialDescriptorBase, _THREEElementDescript);

  function MultiMaterialDescriptorBase(react3Instance) {
    _classCallCheck(this, MultiMaterialDescriptorBase);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MultiMaterialDescriptorBase).call(this, react3Instance));
    ...
    _this.hasProp('materials', {
      type: _ReactPropTypes2.default.array,
      updateInitial: true,
      update: function update(threeObject, materials) {
        // console.log('update', materials);
        _this._materials = [].concat(_toConsumableArray(materials));
  ...
  _createClass(MultiMaterialDescriptorBase, [{
    ...
    value: function applyInitialProps(threeObject, props) {
      ...
      _get(Object.getPrototypeOf(MultiMaterialDescriptorBase.prototype), 'applyInitialProps', this).call(this, threeObject, props);
    }
  }, {
    key: 'setParent',
    value: function setParent(material, parentObject3D) {
      ...
      _get(Object.getPrototypeOf(MultiMaterialDescriptorBase.prototype), 'setParent', this).call(this, material, parentObject3D);
    ...
    key: 'unmount',
    value: function unmount(multimaterial) {
      var parent = multimaterial.userData.markup.parentMarkup.threeObject;
      ...
      if (parent instanceof _three2.default.Mesh || parent instanceof _three2.default.Sprite || parent instanceof _three2.default.Line || parent instanceof _three2.default.Points) {
        var slot = multimaterial.userData._materialSlot;
      ...
      _get(Object.getPrototypeOf(MultiMaterialDescriptorBase.prototype), 'unmount', this).call(this, multimaterial);
    }
  }, {
    key: 'highlight',
  ...
  return MultiMaterialDescriptorBase;
